...
function traerInformacion() {
    $.ajax({
        url: "http://150.136.120.121:8080/api/Admin/all",
        type: "GET",
        datatype: "JSON",
...
function guardarInformacion() {
    ...
    if (validar()) {
        $.ajax({
            url: "http://150.136.120.121:8080/api/Admin/save",
            type: "POST",
            data: dataToSend,
            datatype: "JSON",
...
function editarInformacion() {
    ...
    if (validar()) {
        $.ajax({
            url: "http://150.136.120.121:8080/api/Admin/update",
            type: "PUT",
            data: dataToSend,
            contentType: "application/JSON",
            datatype: "JSON",
...
function borrarElemento(idElemento) {
    ...
    let dataToSend = JSON.stringify(myData);
    $.ajax({
        url: "http://150.136.120.121:8080/api/Admin/" + idElemento,
        type: "DELETE",
        data: dataToSend,
        contentType: "application/JSON",
        datatype: "JSON",
...
function obtenerItemEspecifico(idItem) {
    $.ajax({
        dataType: 'json',
        url: "http://150.136.120.121:8080/api/Admin/" + idItem,
        type: 'GET',
