...
function guardarInformacion() {
    ...
    if (validar()) {
        $.ajax({
            url: "http://150.136.120.121:8080/api/Quadbike/save",
            type: "POST",
            data: dataToSend,
            datatype: "JSON",
...
function editarInformacion() {
    ...
    if (validar()) {
        $.ajax({
            url: "http://150.136.120.121:8080/api/Quadbike/update",
            type: "PUT",
            data: dataToSend,
            contentType: "application/JSON",
            datatype: "JSON",
...
function borrarElemento(idElemento) {
    ...
    let dataToSend = JSON.stringify(myData);
    $.ajax({
        url: "http://150.136.120.121:8080/api/Quadbike/" + idElemento,
        type: "DELETE",
        data: dataToSend,
        contentType: "application/JSON",
        datatype: "JSON",
...
function obtenerItemEspecifico(idItem) {
    $.ajax({
        dataType: 'json',
        url: "http://150.136.120.121:8080/api/Quadbike/" + idItem,
        type: 'GET',
...
function traerCategory() {
    $.ajax({
        url: "http://150.136.120.121:8080/api/Category/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            //console.log(respuesta);
