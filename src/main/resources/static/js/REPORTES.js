function reporteStatus() {
    $.ajax({
        url: "http://150.136.120.121:8080/api/Reservation/report-status",
        type: "GET",
        datatype: "JSON",
...
function reporteFechas() {
    ...
    $.ajax({
        url: "http://150.136.120.121:8080/api/Reservation/report-dates/" + fechaIncial + "/" + fechaFinal,
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
...
function reporteTop() {
    $.ajax({
        url: "http://150.136.120.121:8080/api/Reservation/report-clients",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
