...
function guardarInformacion(){
  ...
  if (validar()){
    $.ajax({
        url:"http://150.136.120.121:8080/api/Category/save",
        type:"POST",
        data:dataToSend,
        datatype:"JSON",
...
function editarInformacion(){
    ...
    if (validar()){
    $.ajax({
        url:"http://150.136.120.121:8080/api/Category/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarElemento(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://150.136.120.121:8080/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function obtenerItemEspecifico(idItem){
    $.ajax({
        dataType: 'json',
        url:"http://150.136.120.121:8080/api/Category/"+idItem,
        type:'GET',
