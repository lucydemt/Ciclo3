...
function traerInformacion() {
    $.ajax({
        url: "http://150.136.120.121:8080/api/Reservation/all",
        type: "GET",
        datatype: "JSON",
...
function guardarInformacion() {
    ...
    if (validar()) {
        $.ajax({
            url: "http://150.136.120.121:8080/api/Reservation/save",
            type: "POST",
            data: dataToSend,
            datatype: "JSON",
...
function editarInformacion() {
    ...
    if (validar()) {
        $.ajax({
            url: "http://150.136.120.121:8080/api/Reservation/update",
            type: "PUT",
            data: dataToSend,
            contentType: "application/JSON",
            datatype: "JSON",
...
function borrarElemento(idElemento) {
    ...
    let dataToSend = JSON.stringify(myData);
    $.ajax({
        url: "http://150.136.120.121:8080/api/Reservation/" + idElemento,
        type: "DELETE",
        data: dataToSend,
        contentType: "application/JSON",
        datatype: "JSON",
...
function obtenerItemEspecifico(idItem) {
    ...
    $.ajax({
        dataType: 'json',
        url: "http://150.136.120.121:8080/api/Reservation/" + idItem,
        type: 'GET',
...
function traerClient() {
    $.ajax({
        url: "http://150.136.120.121:8080/api/Client/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            //console.log(respuesta);
...
function traerQuadbike() {
    $.ajax({
        url: "http://150.136.120.121:8080/api/Quadbike/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            //console.log(respuesta);
